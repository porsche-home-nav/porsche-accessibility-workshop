...
declare type ComponentChunkName = 'banner' | 'button-pure' | 'button' | 'checkbox-wrapper' | 'content-wrapper' | 'divider' | 'fieldset-wrapper' | 'flex' | 'grid' | 'headline' | 'icon' | 'link-pure' | 'link-social' | 'link' | 'marque' | 'modal' | 'pagination' | 'radio-button-wrapper' | 'select-wrapper' | 'spinner' | 'tabs-bar' | 'tabs' | 'text-field-wrapper' | 'text-list' | 'text' | 'textarea-wrapper';
